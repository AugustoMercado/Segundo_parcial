...
class Boss():
        def __init__ (self, tamaño, animaciones, posicion_inicial):
            ...
            rectangulo_boss = self.animaciones["Quieto_izquierda"][0].get_rect()
        ...
        def update_boss(self,pantalla,plataformas):
            match self.accion_boss:
                ...
                case "Quieto_izquierda":
                    self.animar_enemigo(pantalla,"Quieto_izquierda")
                case "Ataque_uno":
                    pygame.mixer.init()
                    ...
                    self.animar_enemigo(pantalla,"Ataque_uno")
                case "ataque_uno_izquierda":
                    pygame.mixer.init()
                    sonido_recolectar = pygame.mixer.Sound("Recursos/Sonidos/Hit_Espada.wav")
                    sonido_recolectar.set_volume(0.1)
                    sonido_recolectar.play()
                    self.animar_enemigo(pantalla,"ataque_uno_izquierda")
                case "Muerte":
