...
def desaparecer_flecha(personaje_flecha, posicion_actual_x,  posicion_actual_y):
    ...
    personaje_flecha.y = posicion_actual_y
...
# Musica
pygame.mixer.init()
musica_ambiente = pygame.mixer.Sound("Bushido Trials.mp3")
...
reescalar_imagenes(lista_animaciones, 90, 80)
...
segunda_plataforma = pygame.transform.scale(plataforma, (450, 20)) 
...
tercera_plataforma = pygame.transform.scale(plataforma, (650, 20))  
...
sexta_plataforma = pygame.transform.scale(plataforma, (650, 20))
...
while flag:
    ...
    PANTALLA.blit(piso_uno,rectangulo_piso)
