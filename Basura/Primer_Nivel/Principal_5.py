...
reescalar_imagenes(lista_animaciones, 70, 80)
...
########################################################################################################
# SUPERFICIE
piso = pygame.image.load("Recursos/Plataforma/1.png")
piso = pygame.transform.scale(piso, (400, 70))
piso = piso.get_rect()
...
plataforma = pygame.transform.scale(
    plataforma, (350, 20)
...
while flag:
    ...
    for lado in lados_piso:
        pygame.draw.rect(PANTALLA, "Gold", lados_piso[lado], 100)
